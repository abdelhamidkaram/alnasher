    ...
    Future<void> createAd() async {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          HomeCubit.get(context).ads.add(Ad.fromJson(response.data['data_response']['ads']));
              ...
              child: Padding(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Text('اضغط هنا لرفع صور المنتج ' , style: Theme.of(context).textTheme.labelLarge!.copyWith(
